export const QuantumBanner = () => {
    return (
        <div className="bg-slate-950/40 backdrop-blur-xl text-white p-3 text-center border-b border-white/5 relative z-50">
            <p className="text-[10px] md:text-xs font-black flex flex-col md:flex-row justify-center items-center gap-2 md:gap-4 tracking-[0.2em] md:tracking-[0.3em] uppercase">
                ...
                <span className="text-slate-400">
                    Layer: <span className="text-white">Crystals-Dilithium</span>
                </span>
                <span className="hidden md:inline opacity-40 select-none">|</span>
                <a
