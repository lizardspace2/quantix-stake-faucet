        ...
        <div className="glass-card w-full p-6 md:p-12 rounded-[1.5rem] md:rounded-[2rem] space-y-8 md:space-y-10 relative overflow-hidden group">
            ...
            <div className="text-center space-y-3 md:space-y-4 relative z-10">
                ...
                <div className="flex flex-col items-center gap-3">
                    <p className="text-slate-400 text-[13px] md:text-sm font-medium max-w-xs mx-auto leading-relaxed">
                        Validate node status to receive protocol rewards.
                    </p>
                    <span className="inline-block px-3 py-1 md:px-4 md:py-1.5 bg-white/5 border border-white/10 rounded-full text-teal-300 text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em]">
                        Limit: 5 QTX / Month
                    </span>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8 relative z-10">
                <div className="space-y-3">
                    <label htmlFor="address" className="text-[9px] md:text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-2 flex justify-between items-center">
                        Receiver Address
                        <span className="hidden sm:inline text-teal-500/50 font-mono lower-case">qtx_address</span>
                    </label>
                ...
                <div className="space-y-3">
                    <label htmlFor="ip" className="text-[9px] md:text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-2 flex items-center justify-between">
                        ...
                        <span className="hidden sm:inline text-purple-500/50 font-mono lower-case">ipv4:port</span>
                    </label>
                    <div className="relative group/input">
                        <input
                            id="ip"
